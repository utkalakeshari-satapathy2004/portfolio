    ...
    return (
        <footer className="relative w-full border-t border-gray-200 dark:border-white/10 bg-white dark:bg-[#020716]">
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full flex items-center justify-center shadow-lg bg-blue-500 hover:bg-blue-600 text-white transition-all duration-300 hover:scale-110"
            >
